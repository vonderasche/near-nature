-- Fix Explorer Board discovery search after harden_security_linter.sql.
-- Symptom: search_public_detections → "permission denied for table users"
-- Safe to re-run (same body as sql/search_public_detections.sql).
